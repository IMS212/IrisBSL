...
import me.jellysquid.mods.sodium.config.user.options.OptionFlag;
import me.jellysquid.mods.sodium.config.user.options.OptionImpact;
import me.jellysquid.mods.sodium.config.user.options.OptionImpl;
