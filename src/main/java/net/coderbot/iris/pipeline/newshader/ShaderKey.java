...
public enum ShaderKey {
	...
	FALLING_SOLID		   (ProgramId.Terrain,     AlphaTests.OFF,			   IrisVertexFormats.ENTITY,                        FogMode.ENABLED),
	FALLING_CUTOUT		   (ProgramId.Terrain,     AlphaTests.ONE_TENTH_ALPHA, IrisVertexFormats.ENTITY,                        FogMode.ENABLED),
	TERRAIN_TRANSLUCENT    (ProgramId.Water,       AlphaTests.OFF,             IrisVertexFormats.TERRAIN,                       FogMode.ENABLED),
	FALLING_TRANSLUCENT    (ProgramId.Water,       AlphaTests.OFF,             IrisVertexFormats.ENTITY,                       FogMode.ENABLED),
