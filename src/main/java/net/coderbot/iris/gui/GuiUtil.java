...
public final class GuiUtil {
	 ...
	 * @param y The y position of the panel
	 */
	public static void drawTextPanel(Font font, Component text, int x, int y) {
		drawPanel( x, y, font.width(text.getString()) + 8, 16);
		font.drawShadow( text.getString(), x + 4, y + 4, 0xFFFFFF);
	}
	 ...
	 */
	public static Component shortenText(Font font, Component text, int width) {
		if (font.width(text.getString()) > width) {
			return new TextComponent(font.substrByWidth(text.getString(), width - font.width(ELLIPSIS.getString()))).append(ELLIPSIS).setStyle(text.getStyle());
		}
		return text;
	}
	 ...
	 */
	public static Component translateOrDefault(Component defaultText, String translationDesc, Object ... format) {
