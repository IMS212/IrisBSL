...
public class BasicTexture {
	...
	public BasicTexture(Builder builder) {
		this.isValid = true;
		...
		if (builder.name != null) {
			GLDebug.nameObject(GL43C.GL_TEXTURE, texture, builder.name + " main");
		}
	...
	public void destroy() {
		...
		GlStateManager._deleteTextures(new int[]{texture});
	}
