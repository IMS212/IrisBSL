...
import net.irisshaders.iris.pipeline.ShaderAccess;
...
public class MixinParticleEngine implements PhasedParticleEngine {
	...
	@Redirect(remap = false, method = {
		...
		"render(Lcom/mojang/blaze3d/vertex/PoseStack;Lnet/minecraft/client/renderer/MultiBufferSource$BufferSource;Lnet/minecraft/client/renderer/LightTexture;Lnet/minecraft/client/Camera;F)V"
	}, at = @At(value = "INVOKE", target = "Lcom/mojang/blaze3d/systems/RenderSystem;setShader(Ljava/util/function/Supplier;)V"), require = 1)
	...
	private Iterator<ParticleRenderType> iris$selectParticlesToRenderForge(Set<ParticleRenderType> instance) {
	...
	@Redirect(remap = false, method = "render(Lcom/mojang/blaze3d/vertex/PoseStack;Lnet/minecraft/client/renderer/MultiBufferSource$BufferSource;Lnet/minecraft/client/renderer/LightTexture;Lnet/minecraft/client/Camera;F)V",
		at = @At(value = "FIELD", target = "Lnet/minecraft/client/particle/ParticleEngine;RENDER_ORDER:Ljava/util/List;"), require = 0)
