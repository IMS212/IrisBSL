...
public enum ShaderKey {
	...
	ENTITIES_ALPHA(ProgramId.Entities, AlphaTests.VERTEX_ALPHA, IrisVertexFormats.DEFAULT_ENTITY_FORMAT, FogMode.PER_VERTEX, LightingModel.LIGHTMAP),
	ENTITIES_SOLID(ProgramId.Entities, AlphaTests.OFF, IrisVertexFormats.DEFAULT_ENTITY_FORMAT, FogMode.PER_VERTEX, LightingModel.LIGHTMAP),
	ENTITIES_SOLID_DIFFUSE(ProgramId.Entities, AlphaTests.OFF, IrisVertexFormats.DEFAULT_ENTITY_FORMAT, FogMode.PER_VERTEX, LightingModel.DIFFUSE_LM),
	ENTITIES_SOLID_BRIGHT(ProgramId.Entities, AlphaTests.OFF, IrisVertexFormats.DEFAULT_ENTITY_FORMAT, FogMode.PER_VERTEX, LightingModel.FULLBRIGHT),
	ENTITIES_CUTOUT(ProgramId.Entities, AlphaTests.ONE_TENTH_ALPHA, IrisVertexFormats.DEFAULT_ENTITY_FORMAT, FogMode.PER_VERTEX, LightingModel.LIGHTMAP),
	ENTITIES_CUTOUT_DIFFUSE(ProgramId.Entities, AlphaTests.ONE_TENTH_ALPHA, IrisVertexFormats.DEFAULT_ENTITY_FORMAT, FogMode.PER_VERTEX, LightingModel.DIFFUSE_LM),
	ENTITIES_TRANSLUCENT(ProgramId.EntitiesTrans, AlphaTests.ONE_TENTH_ALPHA, IrisVertexFormats.DEFAULT_ENTITY_FORMAT, FogMode.PER_VERTEX, LightingModel.DIFFUSE_LM),
	ENTITIES_EYES(ProgramId.SpiderEyes, AlphaTests.NON_ZERO_ALPHA, IrisVertexFormats.DEFAULT_ENTITY_FORMAT, FogMode.PER_VERTEX, LightingModel.FULLBRIGHT),
	ENTITIES_EYES_TRANS(ProgramId.SpiderEyes, AlphaTests.ONE_TENTH_ALPHA, IrisVertexFormats.DEFAULT_ENTITY_FORMAT, FogMode.PER_VERTEX, LightingModel.FULLBRIGHT),
	HAND_CUTOUT(ProgramId.Hand, AlphaTests.ONE_TENTH_ALPHA, IrisVertexFormats.DEFAULT_ENTITY_FORMAT, FogMode.PER_VERTEX, LightingModel.LIGHTMAP),
	HAND_CUTOUT_BRIGHT(ProgramId.Hand, AlphaTests.ONE_TENTH_ALPHA, IrisVertexFormats.DEFAULT_ENTITY_FORMAT, FogMode.PER_VERTEX, LightingModel.FULLBRIGHT),
	HAND_CUTOUT_DIFFUSE(ProgramId.Hand, AlphaTests.ONE_TENTH_ALPHA, IrisVertexFormats.DEFAULT_ENTITY_FORMAT, FogMode.PER_VERTEX, LightingModel.DIFFUSE_LM),
	...
	HAND_TRANSLUCENT(ProgramId.HandWater, AlphaTests.ONE_TENTH_ALPHA, IrisVertexFormats.DEFAULT_ENTITY_FORMAT, FogMode.PER_VERTEX, LightingModel.LIGHTMAP),
	HAND_WATER_BRIGHT(ProgramId.HandWater, AlphaTests.ONE_TENTH_ALPHA, IrisVertexFormats.DEFAULT_ENTITY_FORMAT, FogMode.PER_VERTEX, LightingModel.FULLBRIGHT),
	HAND_WATER_DIFFUSE(ProgramId.HandWater, AlphaTests.ONE_TENTH_ALPHA, IrisVertexFormats.DEFAULT_ENTITY_FORMAT, FogMode.PER_VERTEX, LightingModel.DIFFUSE_LM),
	...
	PARTICLES(ProgramId.Particles, AlphaTests.ONE_TENTH_ALPHA, IrisVertexFormats.PARTICLE, FogMode.PER_VERTEX, LightingModel.LIGHTMAP),
	PARTICLES_TRANS(ProgramId.ParticlesTrans, AlphaTests.ONE_TENTH_ALPHA, IrisVertexFormats.PARTICLE, FogMode.PER_VERTEX, LightingModel.LIGHTMAP),
	WEATHER(ProgramId.Weather, AlphaTests.ONE_TENTH_ALPHA, IrisVertexFormats.PARTICLE, FogMode.PER_VERTEX, LightingModel.LIGHTMAP),
	...
	BLOCK_ENTITY(ProgramId.Block, AlphaTests.ONE_TENTH_ALPHA, IrisVertexFormats.DEFAULT_ENTITY_FORMAT, FogMode.PER_VERTEX, LightingModel.LIGHTMAP),
	BLOCK_ENTITY_BRIGHT(ProgramId.Block, AlphaTests.ONE_TENTH_ALPHA, IrisVertexFormats.DEFAULT_ENTITY_FORMAT, FogMode.PER_VERTEX, LightingModel.FULLBRIGHT),
	BLOCK_ENTITY_DIFFUSE(ProgramId.Block, AlphaTests.ONE_TENTH_ALPHA, IrisVertexFormats.DEFAULT_ENTITY_FORMAT, FogMode.PER_VERTEX, LightingModel.DIFFUSE_LM),
	BE_TRANSLUCENT(ProgramId.BlockTrans, AlphaTests.ONE_TENTH_ALPHA, IrisVertexFormats.DEFAULT_ENTITY_FORMAT, FogMode.PER_VERTEX, LightingModel.DIFFUSE_LM),
	...
	SHADOW_ENTITIES_CUTOUT(ProgramId.ShadowEntities, AlphaTests.ONE_TENTH_ALPHA, IrisVertexFormats.DEFAULT_ENTITY_FORMAT, FogMode.OFF, LightingModel.LIGHTMAP),
	SHADOW_BLOCK(ProgramId.ShadowBlock, AlphaTests.ONE_TENTH_ALPHA, IrisVertexFormats.DEFAULT_ENTITY_FORMAT, FogMode.OFF, LightingModel.LIGHTMAP),
	...
	SHADOW_PARTICLES(ProgramId.Shadow, AlphaTests.ONE_TENTH_ALPHA, IrisVertexFormats.PARTICLE, FogMode.OFF, LightingModel.LIGHTMAP),
