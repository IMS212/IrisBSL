...
public class IrisSodiumCompatMixinPlugin implements IMixinConfigPlugin {
	...
	public void onLoad(String mixinPackage) {
		validSodiumVersion = IrisMultiPlat.isModLoadedMixinPlugin("sodium");

		if (IrisMultiPlat.isModLoadedMixinPlugin("embeddium")) {
			Iris.logger.fatal("A brick is about to fall through your roof at terminal velocity");
		}
